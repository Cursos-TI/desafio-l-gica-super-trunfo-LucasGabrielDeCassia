...
int main() {
    ...
    int comppup1 = 0 , comppup2 = 0;
    int comparea1 = 0 , comparea2 = 0;
    // Instrucoes iniciais 
...
//exibicao dos resultados da comparacao de populacao
if (comppup1 > comppup2) {
    printf("Carta 1 - %s: %lu\n", estado1, populacao1);
    printf("Carta 2 - %s: %lu\n", estado2, populacao2);
    printf("Resultado: Carta 1(%s) Venceu\n\n", estado1);
    printf("-----------------------------------------------\n\n");
} else if (comppup1 < comppup2) {
    printf("Carta 1 - %s: %lu\n", estado1, populacao1);
    printf("Carta 2 - %s: %lu\n", estado2, populacao2);
...
// Comparação da area (maior vence)
...
// Exibicao dos resultados da comparacao de area
